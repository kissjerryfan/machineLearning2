...
def run_ssdp_linear_CoDE():
    ...
    l = -20
    u = 20
    helpers.training_record_for_ssdp(predict_model=method, l=l, u=u, save_folder=save_folder)
...
def run_msdp_FPA_nonz_MSE_train(moea):
    ...
    drawing = 0
    moea = moea
    helpers.training_record_for_msdp(save_folder=save_file, target=target,
